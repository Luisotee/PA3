...
void loop() {
  ...
  if ( (lidoEy == 255) && (eyAnt < 130) ) {
    lidoEy = eyAnt;
    eyAnt = 255;
  }
  else eyAnt = lidoEy;  //FILTRO DE INTERFERENCIAS
  if ( (lidoEx == 255) && (exAnt < 130) ) {
    lidoEx = exAnt;
    exAnt = 255;
  }
  else exAnt = lidoEx;  //FILTRO DE INTERFERENCIAS
  if ( (lidoDx == 255) && (dxAnt < 130) ) {
    lidoDx = dxAnt;
    dxAnt = 255;
  }
  else dxAnt = lidoDx;  //FILTRO DE INTERFERENCIAS
...
void naoCabeca() {
  if (controlePS.Button(PSB_TRIANGLE)) {
